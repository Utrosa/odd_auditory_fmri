...
T1w_path   = homePath + "/data_MRI/derivatives/sub-02/ses-01/anat/sub-02_ses-01_desc-preproc_T1w.nii.gz"
...
#     force_resample=True
# )
# out_path = f"{out_dir}invivo_resampled_to-T1w_res-01.nii.gz"
# resampled_atlas.to_filename(out_path)
